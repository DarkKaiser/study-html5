function insert_sub_comment(form){ return legacy_filter('insert_sub_comment', form, 'socialxe', 'procSocialxeInsertComment', completeInsertSubComment, ['msg','skin','comment_srl','document_srl','content_link'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_sub_comment", {'document_srl': {required:true},'comment_srl': {required:true},'content': {required:true,minlength:1},'skin': {required:true}}]);
