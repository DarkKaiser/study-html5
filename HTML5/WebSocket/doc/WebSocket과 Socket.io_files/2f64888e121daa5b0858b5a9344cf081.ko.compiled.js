function insert_social_comment(form){ return legacy_filter('insert_social_comment', form, 'socialxe', 'procSocialxeInsertComment', completeInsertSocialComment, ['msg','skin','document_srl','list_count','content_link'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["insert_social_comment", {'document_srl': {required:true},'content': {required:true,minlength:1},'skin': {required:true}}]);
