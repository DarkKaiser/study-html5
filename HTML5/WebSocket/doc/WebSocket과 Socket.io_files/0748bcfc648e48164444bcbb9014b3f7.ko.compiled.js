function input_password_for_modify_comment(form){ return legacy_filter('input_password_for_modify_comment', form, 'textyle', 'procTextyleCommentVerificationPassword', completeCheckPasswordForModifyComment, ['error','message'], '', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["input_password_for_modify_comment", {'document_srl': {required:true},'password': {required:true}}]);
