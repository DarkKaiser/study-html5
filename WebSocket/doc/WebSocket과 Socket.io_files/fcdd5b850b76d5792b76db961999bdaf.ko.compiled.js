function insert_comment(form){ return legacy_filter('insert_comment', form, 'textyle', 'procTextyleInsertComment', completeInsertComment, ['error','message','mid','document_srl','comment_srl'], '', {}) };
(function($){
