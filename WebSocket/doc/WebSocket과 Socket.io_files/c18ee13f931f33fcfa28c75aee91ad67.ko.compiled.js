function delete_social_comment(form){ return legacy_filter('delete_social_comment', form, 'socialxe', 'procSocialxeDeleteComment', completeDeleteSocialComment, ['skin','document_srl','list_count','content_link','comment_srl'], '삭제하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["delete_social_comment", {'comment_srl': {required:true}}]);
