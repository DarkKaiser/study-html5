...
<button id="joinOk">테스트1</button><br>
<button id="joinOk2">테스트2</button><br><br>

<button id="jsonRequest">JSON 데이터 요청</button><br>
<button id="xmlRequest">XML 데이터 요청</button><br>
...
$(document).ready(function() {
	...
	$("#joinOk").bind("click",function(){
	    $.ajax({
	        url : "<c:url value='/'/>/cop/example/ajaxAndJson1.do",
	        type: "get",
	        data : { "id" : $("#id").val() },
	...
	$("#joinOk2").bind("click",function(){
	    $.ajax({
	        url : "<c:url value='/'/>/cop/example/ajaxAndJson2.do",
	        type: "get",
	        data : { "id" : $("#id").val() },
	        success : function(responseData){
	...
	$("#jsonRequest").bind("click",function(){
	    $.ajax({
	        ...
	        url : "<c:url value='/'/>/cop/example/ajaxAndJson3.do",
	        type: "get",
	        data : { "id" : $("#id").val() },
	        success : function(responseData){
	            var data = responseData;
	...
	$("#xmlRequest").bind("click",function(){
	    $.ajax({
	    	headers : {
		...
		<div class="rightmain_wrap">			
			<div class="board_wrap">
				...
				<div class="notice_area">
					...
					<a href="<c:url value='/cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA'/>" onclick="javascript:fn_main_headPageAction('43','cop/bbs/selectBoardList.do?bbsId=BBSMSTR_AAAAAAAAAAAA'); return false;" class="more"><img src="<c:url value='/images/index/btn_more.gif' />" alt="more" /></a>
					<ul>
					<c:forEach var="result" items="${notiList}" varStatus="status">
					<li><div class="notice_lefttext">
